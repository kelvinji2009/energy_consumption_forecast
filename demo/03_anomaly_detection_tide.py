...
PLOT_FILENAME = 'anomaly_detection_and_forecast_2025_H1_tide.png'
...
model_energy = TiDEModel.load_from_checkpoint(model_name=MODEL_NAME, work_dir=MODEL_DIR, best=True)
...
plt.title('Energy Consumption: Anomaly Detection and Future Forecast (TiDE Model)')
