...
# Create past covariates TimeSeries (production, temp, humidity)
# TiDE model does not support past covariates, so we will not use them.
...
# --- 3. Model Training ---
print("Initializing and training the TiDE model for total energy consumption...")
...
# model = TiDEModel.load_from_checkpoint(model_name=MODEL_NAME, work_dir=MODEL_OUTPUT_DIR, best=True)
