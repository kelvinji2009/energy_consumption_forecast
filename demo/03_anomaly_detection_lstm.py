...
MODEL_DIR = 'models'
MODEL_NAME = 'lstm_energy_model' # Changed to load the LSTM model
PLOT_OUTPUT_DIR = 'plots'
PLOT_FILENAME = 'anomaly_detection_and_forecast_2025_H1_lstm.png' # Changed filename
...
model_energy = RNNModel.load_from_checkpoint(model_name=MODEL_NAME, work_dir=MODEL_DIR, best=True)
