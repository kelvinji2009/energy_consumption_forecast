...
MODEL_NAME = 'lstm_energy_model' # Changed model name
...
# --- 3. Model Training ---
print("Initializing and training the LSTM model for total energy consumption...")
...
# model = LSTMModel.load_from_checkpoint(model_name=MODEL_NAME, work_dir=MODEL_OUTPUT_DIR, best=True)
